...
with st.sidebar:
    ...
    st.markdown(
        ...
        <div class="sidebar-brand">
            ...
            <div>
                <div class="sidebar-brand-text">GCP Release Notes</div>
    ...
    with st.expander("About this app"):
        st.markdown(
            "Search and explore Google Cloud release notes. "
...
st.markdown(
    ...
    <div class="hero-header">
        ...
        <p class="hero-subtitle">
            Explore and analyze Google Cloud Platform release notes — search, filter, and gain insights from the latest changes.
        </p>
    </div>
    """,
    unsafe_allow_html=True,
...
st.markdown(
    ...
    <div class="metric-container">
        ...
        <div class="metric-card">
            ...
            <div class="metric-value teal">{len(product_names)}</div>
        </div>
    </div>
    """,
    unsafe_allow_html=True,
...
st.markdown(
    ...
    <div class="app-footer">
        GCP Release Notes Navigator &nbsp;·&nbsp; Built by <a href="#">Brice Fotzo</a>
